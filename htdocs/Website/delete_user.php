...
$delete=mysql_query("select Name from UserProfile");
...
<html>
<head>
<title>AEVISTRACK Pte Ltd | Delete User </title>
	...
	function choose(str)
{
    var xmlhttp;
      ...
      xmlhttp.open("GET","fetch.php?User_Name="+str, true);
      xmlhttp.send();
}
...
<!-- Placed js at the end of the document so the pages load faster -->
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Delete User</h3>
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" method="post" action="delete.php" onsubmit="return deleteConfirm();">
								<div class="form-group">
									...
									<div class="col-sm-8"><select name="selector2" id="selector2" class="form-control1" onchange="choose(this.value)">
										<option>Select User Name</option><?php echo $id;?></select></div>
								</div>	
								<div id = "choose"></div>
						</div>
						<div class="panel-footer">
							<div class="row">
								<div class="col-sm-8 col-sm-offset-2">
									<button type="submit" name="delete_user" class="btn btn_5 btn-lg btn-primary" style="float: right; margin-right: 10px;">Delete</button>
								</div>
							</div>
						 </div>
					</div>
