<?php
	...
	$option_default = "<option selected disabled>"."Please select by location name to update information"."</option>";
?>
<!DOCTYPE HTML>
<html>
<head>
<title>AEVISTRACK Pte Ltd | Update Location</title>
...
function fetch(str)
{
    var xmlhttp;
      ...
      xmlhttp.open("GET","update_fetch.php?location_name="+str, true);
      xmlhttp.send();
}
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Update New Location</h3>
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" method="post" action="update_submit.php" onsubmit="return updateConfirm();">
								<div class="form-group">
									...
									<div class="col-sm-8"><select  name="name" id="name" cols="50" rows="4" class="form-control1" onchange="fetch(this.value)"><?php echo $option_default;?><?php echo $options; ?></select></div>
								</div>	
    ...
    var result = confirm("Update this Location?");
    if(result){
        return true;
    }else{
        return false;
