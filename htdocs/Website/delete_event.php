...
$delete=mysql_query("select Event_Name from Event");
while($row = mysql_fetch_array($delete)) {
    $id .="<option>" . $row['Event_Name'] . "</option>";
}
?>
<!DOCTYPE HTML>
<html>
<head>
<title>AEVISTRACK Pte Ltd | Delete Event </title>
	...
	function choose(str)
{
    var xmlhttp;
      ...
      xmlhttp.open("GET","fetch.php?Event_Name="+str, true);
      xmlhttp.send();
}
...
<!-- Placed js at the end of the document so the pages load faster -->
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Delete Event</h3>
						<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" method="post" action="delete.php" onsubmit="return deleteConfirm();">
								<div class="form-group">
									<label for="selector1" class="col-sm-2 control-label">Event Name</label>
									<div class="col-sm-8"><select name="selector4" id="selector4" class="form-control1" onchange="choose(this.value)">
										<option>Select Event Name</option><?php echo $id;?></select></div>
								</div>	
								<div id = "choose"></div>
						</div>
						<div class="panel-footer">
							<div class="row">
								<div class="col-sm-8 col-sm-offset-2">
									<button type="submit" name="delete_event" class="btn btn_5 btn-lg btn-primary" style="float: right; margin-right: 10px;">Delete</button>
								</div>
							</div>
						 </div>
					</div>
