...
<html>
<head>
<title>AEVISTRACK Pte Ltd | Client List Report</title>
...
<!-- Placed js at the end of the document so the pages load faster -->
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
			<button type="button" class="btn btn_5 btn-lg btn-primary" onClick="parent.location='client_pdf.php'" style="float: right;">Save as PDF</button>
             <button type="button" class="btn btn_5 btn-lg btn-primary" onClick="parent.location='client_json.php'" style="float: right; margin-right: 10px;">Export to JSON</button>
				<div class="graphs">
					<h3 class="blank1">Client List Report</h3>
					 <div class="xs tabls">
