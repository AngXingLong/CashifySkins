...
$Username = $_SESSION['SESS_NAME'];
	...
	while ($rows = mysql_fetch_array($result)){
		$options .= "<option>". $rows['name']."</option>";
	}
	$option_default = "<option selected disabled>"."Select Location"."</option>";
?>
<!DOCTYPE HTML>
<html>
<head>
<title>AEVISTRACK Pte Ltd | New Event</title>
...
function fetch(str)
{
    var xmlhttp;
      ...
      xmlhttp.open("GET","event_fetch.php?location_name="+str, true);
      xmlhttp.send();
}
</script>
</head> 
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Add New Event</h3>
						<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" method="post" action="add_submit.php">
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Event Name</label>
									<div class="col-sm-8"><textarea name="event_name" id="event_name" cols="50" rows="4" class="form-control1" required></textarea></div>
								</div>
									  <div class="form-group">
												<label for="txtarea1" class="col-sm-2 control-label">Location</label>
												<div class="col-sm-8"><select  name="location" id="location" cols="50" rows="4" class="form-control1" onchange="fetch(this.value)" required><?php echo $option_default;?><?php echo $options; ?></select></div>
											</div>	
											<div id = "fetch"></div>
								
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Host ID</label>
									<div class="col-sm-8"><textarea name="host_id" id="host_id" cols="50" rows="4" class="form-control1" required></textarea></div>
								</div>
								
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Strict</label>
									<select>
								...
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Time Start</label>
                                    <input type="datetime-local" name="time_start" id="time_start" required>
  									
								</div>
 
								<div class="form-group">
                                <label for="txtarea1" class="col-sm-2 control-label">Time End</label>
