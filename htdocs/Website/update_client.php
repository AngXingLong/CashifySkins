<?php
	...
	$option_default = "<option selected disabled>"."Please select by client Name to update information"."</option>";
?>

<!DOCTYPE HTML>
<html>
<head>
<title>AEVISTRACK Pte Ltd | Update Client</title>
...
function fetch(str)
{
    var xmlhttp;
      ...
      xmlhttp.open("GET","update_fetch.php?client_Name="+str, true);
      xmlhttp.send();
}
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Update New Client</h3>
						  ...
						  <div class="panel-footer">
							<div class="row">
								<div class="col-sm-8 col-sm-offset-2">
									<button class="btn-success btn" type="submit" name="submit_client">Submit</button>
...
if (isset($_GET['err']) && $_GET['err'] == 1){
   ...
   function updateConfirm(){
    var result = confirm("Update this Client?");
    if(result){
        return true;
    }else{
        return false;
