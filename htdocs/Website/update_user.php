<?php
	...
	$option_default = "<option selected disabled>"."Please select by user name to update information"."</option>";
?>
<!DOCTYPE HTML>
<html>
<head>
<title>AEVISTRACK Pte Ltd | Update User</title>
...
function fetch(str)
{
    var xmlhttp;
      ...
      xmlhttp.open("GET","update_fetch.php?user_name="+str, true);
      xmlhttp.send();
}
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Update New User</h3>
    ...
    var result = confirm("Update this User?");
    if(result){
        return true;
    }else{
        return false;
