...
<html>
<head>
<title>AEVISTRACK Pte Ltd | New User </title>
...
<!-- Placed js at the end of the document so the pages load faster -->
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Add New User</h3>
						<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" method="post" action="add_submit.php">	
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Name</label>
									<div class="col-sm-8"><textarea name="name" id="name" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>	
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">NRIC</label>
									<div class="col-sm-8"><textarea name="nric" id="nric" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>	
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">User Name</label>
									<div class="col-sm-8"><textarea name="username" id="username" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Staff ID</label>
									<div class="col-sm-8"><textarea name="staffid" id="staffid" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Password</label>
									<div class="col-sm-8"><textarea name="password" id="password" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Role</label>
									<div class="col-sm-8"><textarea name="role" id="role" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Inactive</label>
									<div class="col-sm-8"><textarea name="inactive" id="inactive" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>
								<div class="form-group">
                                <label for="txtarea1" class="col-sm-2 control-label">Upload photo of user:</label>	
								<input type="file" name="photo">
                                             
								</div>
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Organization ID</label>
									<div class="col-sm-8"><textarea name="organisation_id" id="organisation_id" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>
						</div>
					</div>
						  <div class="panel-footer">
							<div class="row">
								<div class="col-sm-8 col-sm-offset-2">
									<button class="btn-success btn" type="submit" name="submit_user">Submit</button>
