<?php
		...
		$result = mysql_query("SELECT u.ID, u.Username, e.Event_Name, a.Time_In
...
<html>
<head>
<title>AEVISTRACK Pte Ltd | Attendance Report</title>
...
<!-- Placed js at the end of the document so the pages load faster -->
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
			<button type="button" class="btn btn_5 btn-lg btn-primary" onClick="parent.location='attendance_pdf.php'" style="float: right;">Save as PDF</button>
            <button type="button" class="btn btn_5 btn-lg btn-primary" onClick="parent.location='attendance_json.php'" style="float: right; margin-right: 10px;">Export to JSON</button>
				<div class="graphs">
					<h3 class="blank1">Attendance Report</h3>
					 <div class="xs tabls">
						...
						<table class="table" id="datatables">
						  ...
						  <tbody class="stripe hover">
							...
							<tr>
								...
								<td><?=date("d M, Y | H:i A ", strtotime($row['Time_In']))?></td>
							</tr>
							<?php 
							}
							?>
