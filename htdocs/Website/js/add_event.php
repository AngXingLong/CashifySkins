...
require_once('secret/database.php');
  ...
  $Host_ID = $_POST['Host ID'] ;
  $Time_Start = $_POST['Time Start'] ;
  $Time_End = $_POST['Time End'] ;

if(mysql_query("INSERT INTO Event VALUES ('$ID','$Event_Name','$Location_ID','$Host_ID ','$Time_Start','$Time_End')"))
					...
					<h3 class="blank1">Add New Event</h3>
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal">
								<div class="form-group" method="post" form id="event">
								...
								<div class="form-group">
									...
									<div class="col-sm-8"><textarea name="Event Name" id="txtarea1" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>	
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Location ID</label>
									<div class="col-sm-8"><textarea name="Location ID" id="txtarea1" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>	
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Host Name</label>
									<div class="col-sm-8"><textarea name="Host ID" id="txtarea1" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>
                              
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Time Start</label>
									<div class="col-sm-8"><textarea name="Time Start" id="txtarea1" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>
 
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Time End</label>
									<div class="col-sm-8"><textarea name="Time End" id="txtarea1" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>
						</div>
					</di>
