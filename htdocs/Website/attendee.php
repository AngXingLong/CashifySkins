...
<html>
<head>
<title>AEVISTRACK Pte Ltd | Attendee Profile Report</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Easy Admin Panel Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
<link rel="stylesheet" href="http://mp08.bit-mp.biz/responsive.css">
...
<!-- Placed js at the end of the document so the pages load faster -->
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
			<button type="button" class="btn btn_5 btn-lg btn-primary" onClick="parent.location='attendee_pdf.php'" style="float: right;">Save as PDF</button>
             <button type="button" class="btn btn_5 btn-lg btn-primary" onClick="parent.location='attendee_json.php'" style="float: right; margin-right: 10px;">Export to JSON</button>
				<div class="graphs">
					<h3 class="blank1">Attendee Profile Report</h3>
					 <div class="xs tabls">
						...
						<table class="table" id="datatables">
						  ...
						  <tbody class="stripe hover">
							...
							<tr>
								...
								<?php
								if (!empty($row['Photo'])) {
								echo "<img class='img-responsive' src='http://mp08.bit-mp.biz/image/profile-photo/".$row['Photo']."' width='20%' height='20%'>
								<p>".$row['Photo']."</p>";
								}
								else {
								echo "<img class='img-responsive' src='http://epaper2.mid-day.com/images/no_image_thumb.gif' width='20%' height='20%'>
								<p></p>";
								}
								?>
								</td>
