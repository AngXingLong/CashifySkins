...
<html>
<head>
<title>AEVISTRACK Pte Ltd | New Location</title>
					...
					<h3 class="blank1">Add New Location</h3>
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" method="post" action="add_submit.php">
								...
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Street Name</label>
									<div class="col-sm-8"><textarea name="street_name" id="street name" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>	
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Postal Code</label>
									<div class="col-sm-8"><textarea name="postal_code" id="postal code" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Longitude</label>
									<div class="col-sm-8"><textarea name="longitude" id="longitude" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Latitude</label>
									<div class="col-sm-8"><textarea name="latitude" id="latitude" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>
								<div class="form-group">
                                <label for="txtarea1" class="col-sm-2 control-label">Upload map image of the location:</label>
						  ...
						  <div class="panel-footer">
							<div class="row">
								<div class="col-sm-8 col-sm-offset-2">
									<button class="btn-success btn" type="submit" name="submit_location">Submit</button>
