						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" method="post" action="add_submit.php">	
								<div class="form-group">
									...
									<div class="col-sm-8"><textarea name="name" id="name" cols="50" rows="4" class="form-control1" required></textarea></div>
								</div>	
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Contact</label>
									<div class="col-sm-8"><textarea name="contact" id="contact" cols="50" rows="4" class="form-control1" required></textarea></div>
								</div>	
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Address</label>
									<div class="col-sm-8"><textarea name="address" id="address" cols="50" rows="4" class="form-control1" required></textarea></div>
								</div>
						</div>
					</div>
